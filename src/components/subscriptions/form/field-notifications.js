...
export const NotificationStatusManager = ({}) => {
  const [notificationsStatus, setNotificationsStatus] = useState(Notification?.permission);
                ...
                <div className='flex flex-col gap-2 flex-1'>
                  ...
                  >
                    <ToggleGroupItem
                      ...
                      className={cn('data-[state=on]:bg-primary data-[state=on]:text-primary-foreground border', Notification?.permission === 'denied' && 'opacity-50')}
                    >
                      <Icons.bellRing/>
                    </ToggleGroupItem>
                    <ToggleGroupItem
